exports.config =
  ...
  files:
    javascripts:
      ...
      joinTo:
        'javascripts/recline-extensions-model.js': /^app\/lib\/model/
        'javascripts/recline-extensions-backend.js': /^app\/lib\/backend/
        'javascripts/recline-extensions-views.js': /^app\/lib\/views/
