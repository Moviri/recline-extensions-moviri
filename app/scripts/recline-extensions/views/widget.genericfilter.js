define(['backbone', 'recline-extensions-amd', 'mustache', 'chosen', 'jslider', 'datejs', 'jquery-ui.custom.slickgrid'], function (Backbone, recline, Mustache) {
	...
	'
        ...
        createSingleFilter: function (currActiveFilter) {
            ...
            if (currActiveFilter.controlType == "month_week_calendar") {
                ...
                currActiveFilter.tmpValues = _.filter(_.pluck(currActiveFilter.facet.attributes.terms, "term"), function (val) {
