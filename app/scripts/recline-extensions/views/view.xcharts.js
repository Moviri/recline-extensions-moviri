        ...
        updateOptions: function () {
            ...
            if (self.options.state.yAxisTitle) {
                ...
                self.graph._g.selectAll('g.axisY g.titleY').data([self.options.state.yAxisTitle]).enter()
                    ...
                    .append('text').attr('x', -3).attr('y', 0).attr('dy', ".32em").attr('text-anchor', "middle").text(function (d) {
                        return d;
                    });
            }
        },
...
//        	this.model.queryState.off('selection:done', this.redraw);
        ...
        updateSeries: function () {
            ...
            _.each(series, function (d) {
                var serie = {color: d.color, name: d.key, label: d.label, data: _.map(d.values, function (c) {
                    return {x: c.x, y: c.y, x_formatted: c.x_formatted, y_formatted: c.y_formatted, legendField: c.legendField, legendValue: c.legendValue }
                })};
