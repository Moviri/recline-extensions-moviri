require(['REM/recline-extensions/recline-extensions-amd', 'REM/recline-extensions/model/filteredmodel',
'REM/recline-extensions/views/view.slickgrid_graph', 'REM/recline-extensions/backend/backend.jsonp', 'REM/recline-extensions/model/virtualmodel',
    'REM/recline-extensions/views/widget.genericfilter', 'REM/recline-extensions/views/view.indicator'], function (recline) {
...
var filterIdCtrl = new recline.View.GenericFilter({
    ...
    sourceFields:[ {field:"id", controlType:'range_slider', fieldType:"integer", label: "Id", labelPosition:"left" } ],
